...
int main(void){
    ...
    figs = it.analise("figura.txt"); /* it.analise retorna um vetor para a classe figura geometrica,
    ent�o basicamente duplica o vetor*/

    figura = new Sculptor(it.getDX(), it.getDY(), it.getDZ()); // aloca-se um espaco na memoria do tamanho das dimensoes necessarias
