...
vector<FiguraGeometrica *> Interpreter::analise(string filename){
    ...
    if (!fin.is_open()){ // verifica se houve errro na abertura do arquivo, se n�o estiver aberto ele notifica e encerra o processo
    ...
    while(fin.good()){ // o la�o se mantem enquanto o arquvo nao apresenta erro
